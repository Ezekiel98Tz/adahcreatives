...
const CATEGORIES = ['All', 'Corporate & NGO Projects', 'Events & Official Ceremonies', 'Commercial & Brand Shoots', 'Lifestyle, Travel & Aerial']
      ...
      <section className="section" style={{ paddingTop: 0 }}>
        <div className="container">
          <div className="gallery">
            {items.map(p => (
              <figure key={p.id}>
                <Link to={`/work/${p.slug}`} style={{ display: 'block' }}>
